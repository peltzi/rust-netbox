...
pub trait IpamApi {
    fn ipam_aggregates_create(&self, data: crate::models::WritableAggregate) -> Result<crate::models::Aggregate, Error>;
    fn ipam_aggregates_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_aggregates_list(&self, family: Option<&str>, date_added: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, prefix: Option<&str>, rir_id: Option<&str>, rir: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20043, Error>;
    fn ipam_aggregates_partial_update(&self, id: i32, data: crate::models::WritableAggregate) -> Result<crate::models::Aggregate, Error>;
    fn ipam_aggregates_read(&self, id: i32) -> Result<crate::models::Aggregate, Error>;
    fn ipam_aggregates_update(&self, id: i32, data: crate::models::WritableAggregate) -> Result<crate::models::Aggregate, Error>;
    fn ipam_choices_list(&self, ) -> Result<(), Error>;
    fn ipam_choices_read(&self, id: &str) -> Result<(), Error>;
    fn ipam_ip_addresses_create(&self, data: crate::models::WritableIpAddress) -> Result<crate::models::IpAddress, Error>;
    fn ipam_ip_addresses_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_ip_addresses_list(&self, family: Option<&str>, dns_name: Option<&str>, tenant_group_id: Option<&str>, tenant_group: Option<&str>, tenant_id: Option<&str>, tenant: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, parent: Option<&str>, address: Option<&str>, mask_length: Option<f32>, vrf_id: Option<&str>, vrf: Option<&str>, device: Option<&str>, device_id: Option<&str>, virtual_machine_id: Option<&str>, virtual_machine: Option<&str>, interface: Option<&str>, interface_id: Option<&str>, assigned_to_interface: Option<&str>, status: Option<&str>, role: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20044, Error>;
    fn ipam_ip_addresses_partial_update(&self, id: i32, data: crate::models::WritableIpAddress) -> Result<crate::models::IpAddress, Error>;
    fn ipam_ip_addresses_read(&self, id: i32) -> Result<crate::models::IpAddress, Error>;
    fn ipam_ip_addresses_update(&self, id: i32, data: crate::models::WritableIpAddress) -> Result<crate::models::IpAddress, Error>;
    fn ipam_prefixes_available_ips_create(&self, id: i32, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_available_ips_read(&self, id: i32) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_available_prefixes_create(&self, id: i32, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_available_prefixes_read(&self, id: i32) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_create(&self, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_prefixes_list(&self, family: Option<&str>, is_pool: Option<&str>, tenant_group_id: Option<&str>, tenant_group: Option<&str>, tenant_id: Option<&str>, tenant: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, prefix: Option<&str>, within: Option<&str>, within_include: Option<&str>, contains: Option<&str>, mask_length: Option<f32>, vrf_id: Option<&str>, vrf: Option<&str>, region_id: Option<&str>, region: Option<&str>, site_id: Option<&str>, site: Option<&str>, vlan_id: Option<&str>, vlan_vid: Option<f32>, role_id: Option<&str>, role: Option<&str>, status: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20045, Error>;
    fn ipam_prefixes_partial_update(&self, id: i32, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_read(&self, id: i32) -> Result<crate::models::Prefix, Error>;
    fn ipam_prefixes_update(&self, id: i32, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error>;
    fn ipam_rirs_create(&self, data: crate::models::Rir) -> Result<crate::models::Rir, Error>;
    fn ipam_rirs_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_rirs_list(&self, name: Option<&str>, slug: Option<&str>, is_private: Option<&str>, q: Option<&str>, id__in: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20046, Error>;
    fn ipam_rirs_partial_update(&self, id: i32, data: crate::models::Rir) -> Result<crate::models::Rir, Error>;
    fn ipam_rirs_read(&self, id: i32) -> Result<crate::models::Rir, Error>;
    fn ipam_rirs_update(&self, id: i32, data: crate::models::Rir) -> Result<crate::models::Rir, Error>;
    ...
    fn ipam_roles_list(&self, id: Option<&str>, name: Option<&str>, slug: Option<&str>, q: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20047, Error>;
    fn ipam_roles_partial_update(&self, id: i32, data: crate::models::Role) -> Result<crate::models::Role, Error>;
    fn ipam_roles_read(&self, id: i32) -> Result<crate::models::Role, Error>;
    fn ipam_roles_update(&self, id: i32, data: crate::models::Role) -> Result<crate::models::Role, Error>;
    fn ipam_services_create(&self, data: crate::models::WritableService) -> Result<crate::models::Service, Error>;
    fn ipam_services_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_services_list(&self, id: Option<&str>, name: Option<&str>, protocol: Option<&str>, port: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, q: Option<&str>, device_id: Option<&str>, device: Option<&str>, virtual_machine_id: Option<&str>, virtual_machine: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20048, Error>;
    fn ipam_services_partial_update(&self, id: i32, data: crate::models::WritableService) -> Result<crate::models::Service, Error>;
    fn ipam_services_read(&self, id: i32) -> Result<crate::models::Service, Error>;
    fn ipam_services_update(&self, id: i32, data: crate::models::WritableService) -> Result<crate::models::Service, Error>;
    fn ipam_vlan_groups_create(&self, data: crate::models::WritableVlanGroup) -> Result<crate::models::VlanGroup, Error>;
    fn ipam_vlan_groups_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_vlan_groups_list(&self, id: Option<&str>, name: Option<&str>, slug: Option<&str>, q: Option<&str>, region_id: Option<&str>, region: Option<&str>, site_id: Option<&str>, site: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20049, Error>;
    fn ipam_vlan_groups_partial_update(&self, id: i32, data: crate::models::WritableVlanGroup) -> Result<crate::models::VlanGroup, Error>;
    fn ipam_vlan_groups_read(&self, id: i32) -> Result<crate::models::VlanGroup, Error>;
    fn ipam_vlan_groups_update(&self, id: i32, data: crate::models::WritableVlanGroup) -> Result<crate::models::VlanGroup, Error>;
    fn ipam_vlans_create(&self, data: crate::models::WritableVlan) -> Result<crate::models::Vlan, Error>;
    fn ipam_vlans_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_vlans_list(&self, vid: Option<&str>, name: Option<&str>, tenant_group_id: Option<&str>, tenant_group: Option<&str>, tenant_id: Option<&str>, tenant: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, region_id: Option<&str>, region: Option<&str>, site_id: Option<&str>, site: Option<&str>, group_id: Option<&str>, group: Option<&str>, role_id: Option<&str>, role: Option<&str>, status: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20050, Error>;
    fn ipam_vlans_partial_update(&self, id: i32, data: crate::models::WritableVlan) -> Result<crate::models::Vlan, Error>;
    fn ipam_vlans_read(&self, id: i32) -> Result<crate::models::Vlan, Error>;
    fn ipam_vlans_update(&self, id: i32, data: crate::models::WritableVlan) -> Result<crate::models::Vlan, Error>;
    fn ipam_vrfs_create(&self, data: crate::models::WritableVrf) -> Result<crate::models::Vrf, Error>;
    fn ipam_vrfs_delete(&self, id: i32) -> Result<(), Error>;
    fn ipam_vrfs_list(&self, name: Option<&str>, rd: Option<&str>, enforce_unique: Option<&str>, tenant_group_id: Option<&str>, tenant_group: Option<&str>, tenant_id: Option<&str>, tenant: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20051, Error>;
    fn ipam_vrfs_partial_update(&self, id: i32, data: crate::models::WritableVrf) -> Result<crate::models::Vrf, Error>;
    fn ipam_vrfs_read(&self, id: i32) -> Result<crate::models::Vrf, Error>;
    fn ipam_vrfs_update(&self, id: i32, data: crate::models::WritableVrf) -> Result<crate::models::Vrf, Error>;
}
...
impl IpamApi for IpamApiClient {
    ...
    fn ipam_choices_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/ipam/_choices/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn ipam_ip_addresses_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/ipam/ip-addresses/{id}/", configuration.base_path, id=id);
        let mut req_builder = client.delete(uri_str.as_str());
    ...
    fn ipam_prefixes_available_ips_create(&self, id: i32, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error> {
        ...
        let uri_str = format!("{}/ipam/prefixes/{id}/available-ips/", configuration.base_path, id=id);
        let mut req_builder = client.post(uri_str.as_str());
    ...
    fn ipam_prefixes_available_prefixes_create(&self, id: i32, data: crate::models::WritablePrefix) -> Result<crate::models::Prefix, Error> {
        ...
        let uri_str = format!("{}/ipam/prefixes/{id}/available-prefixes/", configuration.base_path, id=id);
        let mut req_builder = client.post(uri_str.as_str());
    ...
    fn ipam_vlan_groups_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/ipam/vlan-groups/{id}/", configuration.base_path, id=id);
        let mut req_builder = client.delete(uri_str.as_str());
