...
pub trait SecretsApi {
    ...
    fn secrets_secret_roles_create(&self, data: crate::models::SecretRole) -> Result<crate::models::SecretRole, Error>;
    fn secrets_secret_roles_delete(&self, id: i32) -> Result<(), Error>;
    fn secrets_secret_roles_list(&self, id: Option<&str>, name: Option<&str>, slug: Option<&str>, q: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20052, Error>;
    fn secrets_secret_roles_partial_update(&self, id: i32, data: crate::models::SecretRole) -> Result<crate::models::SecretRole, Error>;
    fn secrets_secret_roles_read(&self, id: i32) -> Result<crate::models::SecretRole, Error>;
    fn secrets_secret_roles_update(&self, id: i32, data: crate::models::SecretRole) -> Result<crate::models::SecretRole, Error>;
    fn secrets_secrets_create(&self, data: crate::models::WritableSecret) -> Result<crate::models::Secret, Error>;
    fn secrets_secrets_delete(&self, id: i32) -> Result<(), Error>;
    fn secrets_secrets_list(&self, name: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, role_id: Option<&str>, role: Option<&str>, device_id: Option<&str>, device: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20053, Error>;
    fn secrets_secrets_partial_update(&self, id: i32, data: crate::models::WritableSecret) -> Result<crate::models::Secret, Error>;
    fn secrets_secrets_read(&self, id: i32) -> Result<crate::models::Secret, Error>;
    fn secrets_secrets_update(&self, id: i32, data: crate::models::WritableSecret) -> Result<crate::models::Secret, Error>;
}
...
impl SecretsApi for SecretsApiClient {
    ...
    fn secrets_choices_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/secrets/_choices/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn secrets_secret_roles_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/secrets/secret-roles/{id}/", configuration.base_path, id=id);
