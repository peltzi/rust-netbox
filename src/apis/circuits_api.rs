...
pub async fn circuits_circuit_terminations_bulk_delete(
    configuration: &configuration::Configuration,
) -> Result<(), Error<CircuitsCircuitTerminationsBulkDeleteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitTerminationsBulkDeleteError> =
...
pub async fn circuits_circuit_terminations_bulk_update(
    configuration: &configuration::Configuration,
    data: crate::models::WritableCircuitTermination,
) -> Result<crate::models::CircuitTermination, Error<CircuitsCircuitTerminationsBulkUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_circuit_terminations_list(
    ...
    site_id: Option<&str>,
    site: Option<&str>,
    provider_network_id: Option<&str>,
    id__n: Option<&str>,
    id__lte: Option<&str>,
    id__lt: Option<&str>,
    id__gte: Option<&str>,
    ...
    xconnect_id__empty: Option<&str>,
    circuit_id__n: Option<&str>,
    site_id__n: Option<&str>,
    site__n: Option<&str>,
    provider_network_id__n: Option<&str>,
    limit: Option<i32>,
    offset: Option<i32>,
    ...
    if let Some(ref local_var_str) = provider_network_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("provider_network_id", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = provider_network_id__n {
        local_var_req_builder =
            local_var_req_builder.query(&[("provider_network_id__n", &local_var_str.to_string())]);
    }
...
pub async fn circuits_circuit_terminations_paths(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<crate::models::CircuitTermination, Error<CircuitsCircuitTerminationsPathsError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitTerminationsPathsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn circuits_circuit_types_bulk_delete(
    configuration: &configuration::Configuration,
) -> Result<(), Error<CircuitsCircuitTypesBulkDeleteError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitTypesBulkDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::CircuitType, Error<CircuitsCircuitTypesBulkPartialUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_circuit_types_bulk_update(
    configuration: &configuration::Configuration,
    data: crate::models::CircuitType,
) -> Result<crate::models::CircuitType, Error<CircuitsCircuitTypesBulkUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_circuits_bulk_delete(
    configuration: &configuration::Configuration,
) -> Result<(), Error<CircuitsCircuitsBulkDeleteError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitsBulkDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::Circuit, Error<CircuitsCircuitsBulkPartialUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_circuits_bulk_update(
    configuration: &configuration::Configuration,
    data: crate::models::WritableCircuit,
) -> Result<crate::models::Circuit, Error<CircuitsCircuitsBulkUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_provider_networks_bulk_delete(
    configuration: &configuration::Configuration,
) -> Result<(), Error<CircuitsProviderNetworksBulkDeleteError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/circuits/provider-networks/", configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsProviderNetworksBulkDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn circuits_provider_networks_bulk_partial_update(
    configuration: &configuration::Configuration,
    data: crate::models::WritableProviderNetwork,
) -> Result<crate::models::ProviderNetwork, Error<CircuitsProviderNetworksBulkPartialUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_provider_networks_bulk_update(
    configuration: &configuration::Configuration,
    data: crate::models::WritableProviderNetwork,
) -> Result<crate::models::ProviderNetwork, Error<CircuitsProviderNetworksBulkUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_provider_networks_delete(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<(), Error<CircuitsProviderNetworksDeleteError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsProviderNetworksDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn circuits_provider_networks_list(
    ...
    limit: Option<i32>,
    offset: Option<i32>,
) -> Result<crate::models::InlineResponse2003, Error<CircuitsProviderNetworksListError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_provider_networks_read(
    configuration: &configuration::Configuration,
    id: i32,
) -> Result<crate::models::ProviderNetwork, Error<CircuitsProviderNetworksReadError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsProviderNetworksReadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn circuits_providers_bulk_delete(
    configuration: &configuration::Configuration,
) -> Result<(), Error<CircuitsProvidersBulkDeleteError>> {
    let local_var_client = &configuration.client;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsProvidersBulkDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::Provider, Error<CircuitsProvidersBulkPartialUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_providers_bulk_update(
    configuration: &configuration::Configuration,
    data: crate::models::Provider,
) -> Result<crate::models::Provider, Error<CircuitsProvidersBulkUpdateError>> {
    let local_var_client = &configuration.client;
...
pub async fn circuits_providers_list(
    ...
    limit: Option<i32>,
    offset: Option<i32>,
) -> Result<crate::models::InlineResponse2004, Error<CircuitsProvidersListError>> {
    let local_var_client = &configuration.client;
