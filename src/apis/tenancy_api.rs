...
pub trait TenancyApi {
    ...
    fn tenancy_tenant_groups_create(&self, data: crate::models::TenantGroup) -> Result<crate::models::TenantGroup, Error>;
    fn tenancy_tenant_groups_delete(&self, id: i32) -> Result<(), Error>;
    fn tenancy_tenant_groups_list(&self, id: Option<&str>, name: Option<&str>, slug: Option<&str>, q: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20054, Error>;
    fn tenancy_tenant_groups_partial_update(&self, id: i32, data: crate::models::TenantGroup) -> Result<crate::models::TenantGroup, Error>;
    fn tenancy_tenant_groups_read(&self, id: i32) -> Result<crate::models::TenantGroup, Error>;
    fn tenancy_tenant_groups_update(&self, id: i32, data: crate::models::TenantGroup) -> Result<crate::models::TenantGroup, Error>;
    fn tenancy_tenants_create(&self, data: crate::models::WritableTenant) -> Result<crate::models::Tenant, Error>;
    fn tenancy_tenants_delete(&self, id: i32) -> Result<(), Error>;
    fn tenancy_tenants_list(&self, name: Option<&str>, slug: Option<&str>, created: Option<&str>, created__gte: Option<&str>, created__lte: Option<&str>, last_updated: Option<&str>, last_updated__gte: Option<&str>, last_updated__lte: Option<&str>, id__in: Option<&str>, q: Option<&str>, group_id: Option<&str>, group: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20055, Error>;
    fn tenancy_tenants_partial_update(&self, id: i32, data: crate::models::WritableTenant) -> Result<crate::models::Tenant, Error>;
    fn tenancy_tenants_read(&self, id: i32) -> Result<crate::models::Tenant, Error>;
    fn tenancy_tenants_update(&self, id: i32, data: crate::models::WritableTenant) -> Result<crate::models::Tenant, Error>;
}
...
impl TenancyApi for TenancyApiClient {
    ...
    fn tenancy_choices_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/tenancy/_choices/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn tenancy_tenant_groups_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/tenancy/tenant-groups/{id}/", configuration.base_path, id=id);
