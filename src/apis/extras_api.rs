...
pub trait ExtrasApi {
    ...
    fn extras_config_contexts_create(&self, data: crate::models::WritableConfigContext) -> Result<crate::models::ConfigContext, Error>;
    fn extras_config_contexts_delete(&self, id: i32) -> Result<(), Error>;
    fn extras_config_contexts_list(&self, name: Option<&str>, is_active: Option<&str>, q: Option<&str>, region_id: Option<&str>, region: Option<&str>, site_id: Option<&str>, site: Option<&str>, role_id: Option<&str>, role: Option<&str>, platform_id: Option<&str>, platform: Option<&str>, cluster_group_id: Option<&str>, cluster_group: Option<&str>, cluster_id: Option<&str>, tenant_group_id: Option<&str>, tenant_group: Option<&str>, tenant_id: Option<&str>, tenant: Option<&str>, tag: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20037, Error>;
    fn extras_config_contexts_partial_update(&self, id: i32, data: crate::models::WritableConfigContext) -> Result<crate::models::ConfigContext, Error>;
    fn extras_config_contexts_read(&self, id: i32) -> Result<crate::models::ConfigContext, Error>;
    fn extras_config_contexts_update(&self, id: i32, data: crate::models::WritableConfigContext) -> Result<crate::models::ConfigContext, Error>;
    fn extras_custom_field_choices_list(&self, ) -> Result<(), Error>;
    fn extras_custom_field_choices_read(&self, id: &str) -> Result<(), Error>;
    fn extras_export_templates_create(&self, data: crate::models::WritableExportTemplate) -> Result<crate::models::ExportTemplate, Error>;
    fn extras_export_templates_delete(&self, id: i32) -> Result<(), Error>;
    fn extras_export_templates_list(&self, content_type: Option<&str>, name: Option<&str>, template_language: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20038, Error>;
    fn extras_export_templates_partial_update(&self, id: i32, data: crate::models::WritableExportTemplate) -> Result<crate::models::ExportTemplate, Error>;
    fn extras_export_templates_read(&self, id: i32) -> Result<crate::models::ExportTemplate, Error>;
    fn extras_export_templates_update(&self, id: i32, data: crate::models::WritableExportTemplate) -> Result<crate::models::ExportTemplate, Error>;
    fn extras_graphs_create(&self, data: crate::models::Graph) -> Result<crate::models::Graph, Error>;
    fn extras_graphs_delete(&self, id: i32) -> Result<(), Error>;
    fn extras_graphs_list(&self, _type: Option<&str>, name: Option<&str>, template_language: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20039, Error>;
    fn extras_graphs_partial_update(&self, id: i32, data: crate::models::Graph) -> Result<crate::models::Graph, Error>;
    fn extras_graphs_read(&self, id: i32) -> Result<crate::models::Graph, Error>;
    fn extras_graphs_update(&self, id: i32, data: crate::models::Graph) -> Result<crate::models::Graph, Error>;
    fn extras_image_attachments_create(&self, data: crate::models::ImageAttachment) -> Result<crate::models::ImageAttachment, Error>;
    fn extras_image_attachments_delete(&self, id: i32) -> Result<(), Error>;
    fn extras_image_attachments_list(&self, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20040, Error>;
    fn extras_image_attachments_partial_update(&self, id: i32, data: crate::models::ImageAttachment) -> Result<crate::models::ImageAttachment, Error>;
    fn extras_image_attachments_read(&self, id: i32) -> Result<crate::models::ImageAttachment, Error>;
    fn extras_image_attachments_update(&self, id: i32, data: crate::models::ImageAttachment) -> Result<crate::models::ImageAttachment, Error>;
    fn extras_object_changes_list(&self, user: Option<&str>, user_name: Option<&str>, request_id: Option<&str>, action: Option<&str>, changed_object_type: Option<&str>, changed_object_id: Option<f32>, object_repr: Option<&str>, q: Option<&str>, time: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20041, Error>;
    ...
    fn extras_tags_list(&self, name: Option<&str>, slug: Option<&str>, q: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::InlineResponse20042, Error>;
    fn extras_tags_partial_update(&self, id: i32, data: crate::models::Tag) -> Result<crate::models::Tag, Error>;
    fn extras_tags_read(&self, id: i32) -> Result<crate::models::Tag, Error>;
    fn extras_tags_update(&self, id: i32, data: crate::models::Tag) -> Result<crate::models::Tag, Error>;
}
...
impl ExtrasApi for ExtrasApiClient {
    ...
    fn extras_choices_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/_choices/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn extras_config_contexts_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/config-contexts/{id}/", configuration.base_path, id=id);
    ...
    fn extras_custom_field_choices_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/_custom_field_choices/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn extras_export_templates_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/export-templates/{id}/", configuration.base_path, id=id);
        let mut req_builder = client.delete(uri_str.as_str());
    ...
    fn extras_image_attachments_delete(&self, id: i32) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/image-attachments/{id}/", configuration.base_path, id=id);
        let mut req_builder = client.delete(uri_str.as_str());
    ...
    fn extras_object_changes_read(&self, id: i32) -> Result<crate::models::ObjectChange, Error> {
        ...
        let uri_str = format!("{}/extras/object-changes/{id}/", configuration.base_path, id=id);
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn extras_reports_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/reports/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
    ...
    fn extras_reports_run(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/reports/{id}/run/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.post(uri_str.as_str());
    ...
    fn extras_scripts_read(&self, id: &str) -> Result<(), Error> {
        ...
        let uri_str = format!("{}/extras/scripts/{id}/", configuration.base_path, id=crate::apis::urlencode(id));
        let mut req_builder = client.get(uri_str.as_str());
